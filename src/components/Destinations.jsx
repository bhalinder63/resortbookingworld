      ...
      <div className="mx-auto grid max-w-page grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-[26px]">
        {destinations.map((d, i) => (
          <Reveal key={d.name} delay={(i % 4) * 60}>
            <a
              href="#contact"
              className="group relative block h-[260px] overflow-hidden rounded-2xl shadow-[0_6px_20px_rgba(2,62,138,0.08)] transition duration-300 motion-safe:hover:-translate-y-1.5 hover:shadow-[0_20px_40px_rgba(2,62,138,0.16)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ocean"
            >
              <img
                src={d.img}
                alt={d.imgLabel}
